...
class OsseticAnalyzer(Analyzer):
...
if __name__ == '__main__':
    a = OsseticAnalyzer()
    # Check clitics
    analyses = a.analyze_words('бацамынд')
    for ana in analyses:
        print(ana.wf, ana.lemma, ana.gramm, ana.gloss)
    analyses = a.analyze_words('бацамынд', format='xml')
    print(analyses)
    analyses = a.analyze_words('бацамынд', format='json')
    for ana in analyses:
        print(ana)
